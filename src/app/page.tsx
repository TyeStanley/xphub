...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center">
      {/* Hero Section */}
      <section id="hero" className="relative w-full overflow-hidden bg-[#F7F7FD] px-5 pt-8 md:py-0">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center md:flex-row md:justify-center">
          <div className="flex justify-center md:w-1/2 md:justify-start">
            <div className="flex w-full max-w-[520px] flex-col gap-4 px-5 text-center md:items-center md:justify-center md:px-0 md:text-left">
      ...
      {/* Services Section */}
      <section id="services" className="w-full px-5 py-5 md:py-12">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-center md:flex-row md:justify-between lg:gap-14">
          <div className="flex md:w-1/2 md:justify-between">
            <div className="relative flex aspect-square flex-col gap-4 rounded border border-[#E0DEF7] bg-[#F7F7FD] p-5 md:max-w-[550px]">
