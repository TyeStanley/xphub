...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center">
      {/* Hero Section */}
      <section id="hero" className="w-full bg-[#F7F7FD] py-8 md:py-0">
      ...
      <section id="services" className="w-full px-5 py-5 md:py-12">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-center md:flex-row md:justify-between">
